...
public class InventoryPage : MonoBehaviour
{
    ...
    public static List<Item> itemList = new List<Item>{ //char limit of 99 in description 
        // new() { id = 0, name = "Sharpened Talons", desc = "Increases damage you deal", rarity = rarity.Common, stacks = 0, itemAction = () => { PlayerHealth.damage = (int) PlayerHealth.instance.UpgradeStat(PlayerHealth.damage,10); } , baseCost = 1},
        // new() { id = 01, name = "Oats", desc = "Gives you more max health", rarity = rarity.Common, stacks = 0 , itemAction = () => { PlayerHealth.maxHealth = PlayerHealth.instance.UpgradeStat(PlayerHealth.maxHealth,1.1f,true);  } , baseCost = 5},
        // new() { id = 02, name = "Boots", desc = "Increases your waddle speed", rarity = rarity.Common, stacks = 0 , itemAction = () => { TopDownMovement.moveSpeed = PlayerHealth.instance.UpgradeStat(TopDownMovement.moveSpeed,1.05f,true); } , baseCost = 4},
        new() { id = 03, name = "Band-Aid", desc = "Your health slowly regenerates over time", rarity = rarity.Rare, stacks = 0, itemAction = () => { PlayerHealth.regenAmount = PlayerHealth.instance.UpgradeStat(PlayerHealth.regenAmount,1f); }, baseCost = 2 },
        new() { id = 04, name = "Illegal Trigger", desc = "You shoot faster", rarity = rarity.Common, stacks = 0 , itemAction = () => { Shooting.firerate = PlayerHealth.instance.UpgradeStat(Shooting.firerate,0.9f,true); } , baseCost = 1},
        new() { id = 05, name = "Chompers", desc = "Your hits bleed enemies", rarity = rarity.Uncommon, stacks = 0 , itemAction = () => {EnemyHealth.bleedAmount = (int) PlayerHealth.instance.UpgradeStat(EnemyHealth.bleedAmount,5); } , baseCost = 1},
        new() { id = 06, name = "Leech", desc = "Your hits on enemies heal you", rarity = rarity.Rare, stacks = 0 , itemAction = () => {PlayerHealth.lifestealAmount = PlayerHealth.instance.UpgradeStat(PlayerHealth.lifestealAmount,1f); } , baseCost = 1},
        new() { id = 07, name = "Explosive Bullets", desc = "Your bullets explode on impact", rarity = rarity.Rare, stacks = 0, itemAction = () => { PlayerHealth.explosionSize = (int) PlayerHealth.instance.UpgradeStat(PlayerHealth.explosionSize,1); PlayerHealth.instance.UpgradeStat(PlayerHealth.explosionSize,1); }, baseCost = 1},
        ...
        new() { id = 09, name = "Lucky Feather", desc = "You have an increased chance to deal critical damage" , rarity = rarity.Uncommon, stacks = 0, itemAction = () => {PlayerHealth.CritChance = PlayerHealth.instance.UpgradeStat(PlayerHealth.CritChance,0.07f); }, baseCost = 1 },
